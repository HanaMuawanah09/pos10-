...
<div class="container mt-3">
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid px-0">
            <a class="navbar-brand" href="<?php echo e(Route::has('dashboard') ? route('dashboard') : url('/dashboard')); ?>">
...
</html><?php /**PATH C:\laragon\www\pos8-main\resources\views/layouts/app.blade.php ENDPATH**/ ?>