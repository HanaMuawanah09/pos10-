...
<div style="max-width: 780px; margin: 0 auto; padding: 4px 0 30px;">
    ...
    <div class="tt-profile">
        <div class="tt-profile-top">
            <div class="tt-avatar">
                <img src="<?php echo e(asset('images/hna.gif')); ?>" alt="Hana Muawanah">
            </div>
            <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pos9-main\resources\views/tentang.blade.php ENDPATH**/ ?>